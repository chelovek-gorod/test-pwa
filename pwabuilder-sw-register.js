                   ...
                   if (e.indexOf(s) >= 0) {
                       ...
                       for (let e = 0; e < a; e++) {
                           ...
                           if ("" === n)
                               ...
                               const t = d.exec(n);
                               null !== t && o(t[2], "$lit$") && (n = n.slice(0, t.index) + t[1] + t[2].slice(0, -"$lit$".length) + t[3]),
   ...
   _clone() {
       ...
       for (; o < i.length; )
           ...
           a(r)) {
               for (; l < r.index; )
                   l++,
                   "TEMPLATE" === d.nodeName && (s.push(d),
                   n.currentNode = d.content),
                   null === (d = n.nextNode()) && (n.currentNode = s.pop(),
                   d = n.nextNode());
               if ("node" === r.type) {
                   const t = this.processor.handleTextExpression(this.options);
                   t.insertAfterNode(d.previousSibling),
                   this.__parts.push(t)
               } else
                   this.__parts.push(...this.processor.handleAttributeExpressions(d, r.name, r.strings, this.options));
               o++
           } else
...
class w {
   ...
   getTemplateElement() {
       ...
       let e = this.getHTML();
       return void 0 !== _ && (e = _.createHTML(e)),
       t.innerHTML = e,
       t
   }
}
...
class P {
   ...
   setValue(t) {
       t === m || S(t) && t === this.value || (this.value = t,
       f(t) || (this.committer.dirty = !0))
   }
   commit() {
       for (; f(this.value); ) {
           const t = this.value;
...
class T {
   ...
   commit() {
       ...
       const t = this.__pendingValue;
       t !== m && (S(t) ? t !== this.value && this.__commitText(t) : t instanceof w ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : b(t) ? this.__commitIterable(t) : t === g ? (this.value = g,
...
function O(t) {
   ...
   void 0 === i && (i = new r(t,t.getTemplateElement()),
   e.keyString.set(n, i)),
...
class {
   handleAttributeExpressions(t, e, s, i) {
       ...
       if ("@" === n)
           return [new k(t,e.slice(1),i.eventContext)];
       if ("?" === n)
           return [new N(t,e.slice(1),s)];
 ...
 */
 , $ = (t,e)=>`${t}--${e}`;
let j = !0;
void 0 === window.ShadyCSS ? j = !1 : void 0 === window.ShadyCSS.prepareTemplateDom && (console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),
j = !1);
const I = t=>e=>{
   const i = $(e.type, t);
   let n = V.get(i);
   ...
   return n.stringsArray.set(e.strings, o),
   o
}
 , q = ["html", "svg"]
 , z = new Set
...
class tt extends D {
   ...
   update(t) {
       const e = this.render();
       super.update(t),
       e !== X && this.constructor.render(e, this.renderRoot, {
...
var et = function(t, e, s, i) {
   ...
   return r > 3 && o && Object.defineProperty(e, s, o),
   o
};
